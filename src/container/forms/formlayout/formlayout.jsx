...
import { layout1, layout10, layout11, layout12, layout2, layout3, layout4, layout5, layout6, layout7, layout8, layout9 } from "../../../components/ui/data/formsdata/formsprism";
...
const Formlayout = () => {
	...
	return (
		<Fragment>
			...
			<Row>
				<Col xl={6}>
					<Showcode title="Inline forms" code={layout3}>
				...
				<Col xl={6}>
					<Showcode title="Column sizing" code={layout4}>
						<Row className="g-3">
							<Col sm={7} className="">
			...
			<Row>
				<Col xl={6}>
					<Showcode title="Utilities" code={layout5}>
						<div className="mb-3">
				...
				<Col xl={6}>
					<Showcode title="Horizontal form label sizing" code={layout6}>
						<Row className="mb-3">
			...
			<Row>
				<Col xl={6}>
					<Showcode title="Vertical Forms with icon" code={layout7}>
						<div className="mb-3">
				...
				<Col xl={6}>
					<Showcode title="Horizontal form With Icons" code={layout8}>
						<Form>
							<Row className="mb-3">
			...
			<Row>
				<Col xl={12}>
					<Showcode title="Auto sizing" code={layout9}>
			...
			<Row>
				<Col xxl={6}>
					<Showcode title="Form grid" code={layout10}>
						<Row>
				...
				<Col xxl={6}>
					<Showcode title="Gutters" code={layout11}>
			...
			<Row>
				<Col xl={4}>
					<Showcode title="Contact Us Form" code={layout12} customCardClass="contactus-form overflow-hidden">
						<Row>
							<Col xl={12} className="rounded-3">
								<div className="row gy-2">
									...
									<div className="col-xl-6 mt-4">
										...
										<input type="email" className="form-control" id="contact-address-email" placeholder="Enter Email Id" />
									</div>
								...
								<div className="text-center mt-4">
									<button className="btn btn-primary btn-wave">Send Message</button>
								</div>
							</Col>
						</Row>
					</Showcode>
