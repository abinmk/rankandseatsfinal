...
export const Shapeworldmap = () => {
	return (
		<ComposableMap projectionConfig={{ scale: 147 }}>
			...
			<Geographies geography={geoUrl} stroke="lightgrey">
				{({ geographies }) =>
					geographies.map((geo) => (
						<Geography
							key={geo.rsmKey}
								...
								<g key={geo.rsmKey + "-name"}>
									{cur &&
										...
										(Object.keys(offsets).indexOf(cur.id) === -1 ? (
											...
											<Annotation
												subject={centroid}
												// dx={offsets[cur.offsets][0]}
												// dy={offsets[cur.offsets][1]}	
												connectorProps={{ /* Add valid SVGProps<SVGPathElement> properties here */ }} >
												<text x={4} fontSize={14} alignmentBaseline="middle">  {cur.id}</text></Annotation>
