					...
					<Card className="custom-card">
						...
						<Card.Body>
							<div className="row gy-3">
								...
								<Col xl={12}>
									<Form.Control type="text" id="invoice-payment-cardname" placeholder="Card Number" defaultValue="1234 5678 9087 XXXX" />
									<label htmlFor="invoice-payment-cardname" className="form-label mb-0"><a className="text-danger fs-11" href="#;">Enter valid card number*</a></label>
								</Col>
								<Col xl={12}>
