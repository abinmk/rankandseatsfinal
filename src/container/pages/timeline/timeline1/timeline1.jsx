	...
	return (
		<Fragment>
			<div className="row justify-content-center">
				<div className="col-xxl-9 col-xl-10 col-sm-12">
					<ul className="timeline list-unstyled">
						<li>
							<div className="timeline-time text-end">
								<span className="time d-inline-block">Today</span>
							</div>
									...
									<div className="flex-fill">
										<div className="align-items-center">
											<div className="mt-sm-0 mt-2">
												...
												<p className="mb-0 text-muted">Temporary data will be <span className="badge bg-danger-transparent fw-semibold mx-1">deleted</span> once dedicated time complated Lorem ipsum dolor sit amet consectetur adipisicing elit time complated Lorem ipsum dolor sit amet consectetur adipisicing elit</p>
											</div>
						...
						<li>
							<div className="timeline-time text-end">
								<span className="time d-inline-block">05 May</span>
							</div>
							<div className="timeline-icon">
								<a href="#"></a>
							</div>
									...
									<div className="flex-fill">
										<div className="align-items-center">
											<div className="mt-sm-0 mt-2">
												...
												<p className="mb-0 text-muted">Social network accounts are at risk check your <span className="badge bg-success-transparent fw-semibold mx-1">login</span> details Lorem ipsum dolor sit amet consectetur adipisicing
													elit time complated Lorem ipsum dolor sit amet consectetur adipisicing elit
												<Link to="#" className="text-primary ms-2 text-decoration-underline d-inline-block">Read more</Link></p>
											</div>
											<div className="ms-auto">
												<span className="float-end badge bg-light text-muted timeline-badge mt-2  rounded-1">
													10:00 AM
						...
						<li>
							<div className="timeline-time text-end">
								<span className="time d-inline-block">04 May</span>
							</div>
							<div className="timeline-icon">
								<a href="#"></a>
							</div>
						...
						<li>
							<div className="timeline-time text-end">
								<span className="time d-inline-block">15 Sep</span>
							</div>
							<div className="timeline-icon">
								<a href="#"></a>
							</div>
