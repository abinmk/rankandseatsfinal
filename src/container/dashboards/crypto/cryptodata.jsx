...
//
export class Trademeter extends Component {
	constructor(props) {
		super(props);
	...
	render() {
		return (
			<ReactApexChart options={this.state.options} series={this.state.series} type="radialBar" height={200} width={230} />
...
//
export class DTC extends Component {
	constructor(props) {
		super(props);
