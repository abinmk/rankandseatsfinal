...
import { Backgroundcards, Gridcards, Gridmarkupcards, Mountaincards } from "./cardsdata";
...
import media41 from "../../../assets/images/media/media-28.jpg";
	...
	return (
		<Fragment>
			<Row>
				<Col xxl={3} xl={6} lg={6} md={6} sm={12}>
					<Card className="custom-card">
						<img src={media22} className="card-img-top" alt="..." />
						<Card.Body>
				...
				<Col xxl={3} xl={6} lg={6} md={6} sm={12}>
					...
					<Card className="custom-card">
						...
						<Card.Footer>
							<Link to="#" className="card-link text-danger">Buy Now</Link>
							<Link to="#" className="card-link text-success d-inline-flex"><u>Review</u></Link>
						</Card.Footer>
					</Card>
				</Col>
				<Col xxl={3} xl={6} lg={6} md={6} sm={12}>
				...
				<Col xxl={3} xl={6} lg={6} md={6} sm={12}>
					<Card className="custom-card">
						<img src={media24} className="card-img-top" alt="..." />
						<Card.Body>
							<h6 className="card-title fw-semibold">Card title</h6>
							<p className="card-text">Some quick example text to build on the card title and
								make up the bulk of the card's content.</p>
			...
			<Row>
				<div className="col-xl-9">
					...
					<Row>
						...
						<div className="col-xl-4">
							<div className="card text-end custom-card">
								<Card.Body>
									<div className="mb-2">
										<span className="avatar avatar-md">
				...
				<div className="col-xl-3">
					<Row>
						...
						<Col xl={12}>
							<div className="card custom-card border border-success mb-3">
							...
							<div className="col" key={Math.random()}>
								<Card className="custom-card">
									<Card.Body>
										...
										<Link to="#" className={`btn btn-${idx.color}`}>Purchase</Link>
									</Card.Body>
								</Card>
							</div>
						))}
					...
					<Card className="custom-card text-center">
						...
						<div className="card-body pt-1">
							...
							<div className="btn-list">
								<Button variant='' aria-label="button" type="button" className="btn btn-icon btn-facebook btn-wave">
									<i className="ri-facebook-line"></i>
								</Button>
								<Button variant='' aria-label="button" type="button" className="btn btn-icon btn-twitter btn-wave">
									<i className="ri-twitter-line"></i>
								</Button>
								<Button variant='' aria-label="button" type="button" className="btn btn-icon btn-instagram btn-wave">
				...
				<Col md={4}>
					<Card className="custom-card">
						<Card.Header className="card-header justify-content-between">
							...
							<Link aria-label="anchor" to="#" onClick={BasicHandleExpandClick}>
								<i className={`fe ${BasicExpanded ? "fe-chevron-up" : "fe-chevron-down"}`}></i></Link>
						</Card.Header>
						<Collapse in={BasicExpanded} timeout={3000}>
							<div>
								...
								<Card.Footer>
									<Button variant='' type="button" className="btn btn-primary">Read More</Button>
								</Card.Footer>
							</div>
						</Collapse>
					</Card>
					...
					{Basicshow ?
						<Card className="custom-card">
							<div className="card-header justify-content-between">
								...
								<Link aria-label="anchor" to="#" onClick={() => setBasicshow(false)}>
				...
				<Col md={4}>
					<Card className="custom-card">
						<Card.Header className="justify-content-between">
							...
							<Link aria-label="anchor" to="#" data-bs-toggle="card-fullscreen" onClick={() => handleShow(true)}>
								<i className="ri-fullscreen-line"></i>
							</Link>
							<Modal show={fullscreenshow} fullscreen={fullScreen} onHide={() => setfullscreenShow(false)}>
								<Modal.Header>
									<Modal.Title className="fs-15">Fullscreen Button</Modal.Title>
			...
			<Row>
				<Col xl={4} md={6}>
					<Card className="custom-card">
						<img src={media29} className="card-img-top" alt="..." />
						<Card.Body>
				...
				<Col xl={4} md={6}>
					<Card className="custom-card">
						...
						<img src={media28} className="card-img-bottom" alt="..." />
					</Card>
				</Col>
				<Col xl={4} md={6}>
					<Card className="custom-card">
						...
						<img src={media30} className="card-img rounded-0" alt="..." />
						<Card.Body>
							<p className="card-text mb-0"><small>Last updated 3 mins
								ago</small></p>
						</Card.Body>
				...
				<Col xl={4} md={6}>
					<Card className="custom-card">
						<Card.Header>
							<Card.Title>Image caps are widely used in Blog's</Card.Title>
						</Card.Header>
						<Card.Body>
							<p className="card-text mb-1 text-muted">This is a wider card with supporting text below
								as
				...
				<Col xl={4} md={6}>
					<Card className="custom-card">
						...
						<img src={media33} className="card-img-bottom" alt="..." />
					</Card>
				</Col>
			</Row>
			...
			<Row>
				<div className="col-lg-4">
					<div className="card custom-card bg-dark overlay-card">
						...
						<div className="card-img-overlay d-flex flex-column p-0">
							...
							<Card.Body className="overflow-scroll">
								...
								<div className="card-text  text-fixed-white">Last updated 3 mins ago</div>
							</Card.Body>
						</div>
					</div>
				</div>
					...
					<Card className="custom-card bg-dark overlay-card">
						...
						<div className="card-img-overlay d-flex flex-column p-0 over-content-bottom">
							<Card.Body className="">
								...
								<div className="card-text mb-2 text-fixed-white cards-subtext text-truncate">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even.</div>
								<div className="card-text  text-fixed-white">Last updated 3 mins ago</div>
							</Card.Body>
				...
				<Col lg={4}>
					<Card className="custom-card bg-dark overlay-card">
						<img src={media34} className="card-img" alt="..." />
						<div className="card-img-overlay d-flex flex-column p-0">
							<Card.Header>
							...
							<Card.Body className="overflow-y-scroll">
								<div className="card-text text-fixed-white">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even.</div>
							</Card.Body>
							<div className="card-footer text-fixed-white">Last updated 3 mins ago</div>
						</div>
					</Card>
					...
					<Row>
						<div className="col-xl-6">
							<div className="card custom-card w-75">
								<Card.Header>
									<Card.Title>Using Width 75%</Card.Title>
								</Card.Header>
								<Card.Body>
									<div className="card-text">
						...
						<div className="col-xl-6">
							<div className="card custom-card w-50">
								<Card.Header>
									<Card.Title>Using Width 50%</Card.Title>
								</Card.Header>
								<Card.Body>
									<div className="card-text">
								...
								<Card.Header>
									<ul className="nav nav-tabs card-header-tabs">
										<li className="nav-item">
											<Link className="nav-link active" aria-current="true" to="#">Active</Link>
										</li>
										<li className="nav-item">
					...
					<Card className="custom-card">
						<div className="row g-0">
							...
							<div className="col-md-8">
								<Card.Header>
									<Card.Title>Horizontal Cards</Card.Title>
								</Card.Header>
								<Card.Body>
			...
			<Row>
				<Col xl={12}>
					<div className="card-group">
						<Card className="custom-card">
							<img src={media40} className="card-img-top" alt="..." />
							<Card.Body>
						...
						<Card className="custom-card">
							<img src={media41} className="card-img-top" alt="..." />
							<Card.Body>
						...
						<Card className="custom-card">
							<img src={media42} className="card-img-top" alt="..." />
							<Card.Body>
						...
						<Card className={`custom-card card-bg-${idx.color}`}>
							<Card.Body>
								<div className="d-flex align-items-center w-100">
									...
									<div className="">
										<div className="fs-15 fw-semibold">{idx.text1}</div>
										<p className={`mb-0 ${idx.class} op-7 fs-12`}>{idx.text2}</p>
									</div>
									<div className="ms-auto">
										<Link to="#" className={idx.class}><i className="bi bi-three-dots-vertical"></i></Link>
									</div>
								</div>
							</Card.Body>
						</Card>
					...
					<div className="card border border-info custom-card">
						<Card.Body>
							<p className="fs-14 fw-semibold mb-2 lh-1">New Project Discussion
								<Link aria-label="anchor" to="#"><i className="bi bi-plus-square float-end text-info fs-18"></i></Link>
							</p>
							<div className="d-flex flex-wrap gap-2 mb-4">
								<span className="badge bg-info-transparent">React</span>
					...
					<div className="card border border-danger custom-card">
						<Card.Body>
							<p className="fs-14 fw-semibold mb-2 lh-1">Recent Projects Testing
								<Link aria-label="anchor" to="#"><i className="bi bi-plus-square float-end text-danger fs-18"></i></Link>
							</p>
							<div className="d-flex flex-wrap gap-2 mb-4">
					...
					<div className="card border border-light custom-card">
						<Card.Body>
							<p className="fs-14 fw-semibold mb-2 lh-1">New Employees
								<Link aria-label="anchor" to="#"><i className="bi bi-plus-square float-end text-default fs-18"></i></Link>
							</p>
							<div className="d-flex flex-wrap gap-2 mb-4">
								<span className="badge bg-warning-transparent">Html</span>
					...
					<div className="card border border-dark custom-card">
						<Card.Body>
							<p className="fs-14 fw-semibold mb-2 lh-1">Terminated Employees
								<Link aria-label="anchor" to="#"><i className="bi bi-plus-square float-end text-dark fs-18"></i></Link>
							</p>
							<div className="d-flex flex-wrap gap-2 mb-4">
