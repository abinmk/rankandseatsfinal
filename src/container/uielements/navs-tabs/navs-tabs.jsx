...
//IMAGES
import ecommerce3 from "../../../assets/images/ecommerce/jpg/1.jpg";
			...
			<Row>
				<Col xl={6}>
					<Card className="custom-card">
						...
						<Card.Body>
							<Nav className="nav nav-tabs" as="ul">
								<Nav.Item as="li">
			...
			<Row>
				<Col xl={6}>
					<Card className="custom-card">
						...
						<Card.Body>
							<Tab.Container defaultActiveKey="first">
								<Nav className="nav nav-tabs mb-3" id="myTab" role="tablist" defaultActiveKey="first">
			...
			<Row>
				...
				<div className="col-xxl-6 col-xl-6">
					<Card className="custom-card">
						...
						<Card.Body>
							<Tab.Container defaultActiveKey="first">
								<Nav variant="pills" className="nav nav-tabs justify-content-center mb-5 tab-style-3" id="myTab2" role="tablist" defaultActiveKey="first">
									<Nav.Item>
			...
			<Row>
						...
						<Card.Body>
							<Tab.Container defaultActiveKey="first">
								...
								<Tab.Content className="tab-content" id="myTabContent2">
									<Tab.Pane className="tab-pane fade show  p-0 border-bottom-0 rounded-0" id="products-tab-pane" eventKey="first"
				...
				<Col xl={8}>
					<Card className="custom-card">
						...
						<Card.Body className="card-body d-flex align-items-start">
							<Tab.Container id="left-tabs-example" defaultActiveKey="first">
								<Row>
									<Col md={3}>
							...
							<Tab.Container defaultActiveKey="first">
								<nav>
									<Nav variant="pills" className="nav nav-tabs nav-justified tab-style-4 d-flex" id="myTab2" role="tablist" defaultActiveKey="first">
										...
										<Nav.Link eventKey="fourth" id="nav-contact-tab" type="button">Services</Nav.Link>
								...
								<Tab.Content className="tab-content" id="tab-style-4">
									...
									<Tab.Pane className="" id="nav-contact1" role="tabpanel" eventKey="fourth"
										aria-labelledby="nav-contact-tab" tabIndex={0}>
										<b>Contrary to popular belief</b>
			...
			<Row>
				<Col xl={6}>
					<Card className="custom-card">
						...
						<Card.Body>
							<Tab.Container id="left-tabs-example" defaultActiveKey="first">
								<Nav variant='tabs' className="nav nav-tabs mb-3 border-0" role="tablist">
									<Nav.Item>
							...
							<Tab.Container id="left-tabs-example" defaultActiveKey="first">
								<Nav variant='pills' className="nav nav-pills mb-3" role="tablist" defaultActiveKey="first">
									...
									<Dropdown className="nav-item dropdown" >
										...
										<Dropdown.Menu>
											<Dropdown.Item href="#" eventKey="second"
