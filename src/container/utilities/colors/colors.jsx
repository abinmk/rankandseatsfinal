...
import { Backgrounddata, Othercolors, Outlinedata } from "./colorsdata";
...
const Colors = () => {
	return (
		<Fragment>
			<Row>
				<div className="col-12">
					<Card className="custom-card">
						...
						<Card.Body>
							<Row className="row-cols-sm-5 row-cols-lg-auto d-flex align-items-center">
					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Row className="row-cols-sm-5 row-cols-lg-auto d-flex align-items-center">
								{Outlinedata.map((idx) => (
									<div className="p-3 col" key={Math.random()}>
										<div className={`m-2 bg-outline-${idx.class} mx-auto color-container`}><i className="bx bxs-happy  fs-22"></i></div>
					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Row className="row-cols-sm-5 row-cols-lg-auto d-flex align-items-center">
								...
								<div className="p-3 col">
									<div className="m-2 text-muted fw-semibold fs-14 text-center">muted</div>
									<p className="pb-0 mb-0 fw-semibold text-center"><code>.text-muted</code></p>
								</div>
							</Row>
						</Card.Body>
					</Card>
						...
						<Col xl={12}>
							<Card className="custom-card">
								...
								<Card.Body>
									<Row className="row-cols-sm-5 row-cols-lg-auto d-flex align-items-center">
										<div className="p-3 col">
											<div className="m-2 text-primary fw-semibold fs-18 text-center">Opacity-100</div>
											<p className="pb-0 mb-0 fw-semibold text-center"><code>100% opacity</code></p>
										</div>
										<div className="p-3 col">
											<div className="m-2 text-primary text-opacity-75 fw-semibold fs-18 text-center">Opacity-100</div>
											<p className="pb-0 mb-0 fw-semibold text-center"><code>.text-opacity-75</code></p>
										</div>
										<div className="p-3 col">
											<div className="m-2 text-primary text-opacity-50 fw-semibold fs-18 text-center">Opacity-100</div>
											<p className="pb-0 mb-0 fw-semibold text-center"><code>.text-opacity-50</code></p>
										</div>
										<div className="p-3 col">
											<div className="m-2 text-primary text-opacity-25 fw-semibold fs-18 text-center">Opacity-100</div>
			...
			<Row>
				{Othercolors.map((idx) => (
					<Col xxl={2} lg={4} sm={6} key={Math.random()}>
						<Card className="custom-card">
							<Card.Body>
								<div className={`flex-fill p-3 bd-${idx.color}-100`}>$blue-100</div>

								<div className={`flex-fill p-3 bd-${idx.color}-200`}>$blue-200</div>

								<div className={`flex-fill p-3 bd-${idx.color}-300`}>$blue-300</div>

								<div className={`flex-fill p-3 bd-${idx.color}-400`}>$blue-400</div>

								<div className={`flex-fill p-3 bd-${idx.color}-500`}>$blue-500</div>

								<div className={`flex-fill p-3 bd-${idx.color}-600`}>$blue-600</div>

								<div className={`flex-fill p-3 bd-${idx.color}-700`}>$blue-700</div>

								<div className={`flex-fill p-3 bd-${idx.color}-800`}>$blue-800</div>

								<div className={`flex-fill p-3 bd-${idx.color}-900`}>$blue-900</div>

								<div className={`flex-fill p-3 bd-${idx.color}`}>$blue</div>
							</Card.Body>
						</Card>
					</Col>
				))}
