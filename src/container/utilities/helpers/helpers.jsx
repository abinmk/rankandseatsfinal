				...
				<Col xxl={4} xl={4} lg={6} md={6} sm={12}>
					<Card className="custom-card">
						...
						<Card.Body>
							...
							<Card className="text-bg-info mb-3" style={{ maxWidth: "18rem" }}>
					...
					<Card className="custom-card">
						...
						<Card.Body>
							...
							<div className="card-body pb-0">
								<Card.Title>Card with stretched links</Card.Title>
					...
					<Card className="custom-card">
						...
						<Card.Body>
							<div className="d-flex justify-content-evenly flex-wrap">
								...
								<Link to="#" className="link-light fw-semibold fs-15 p-1 bg-dark rounded-1">Light</Link>
						...
						<Col xl={12}>
							<Card className="custom-card">
								...
								<Card.Body className="bd-example-ratios bd-example-ratios-breakpoint">
									...
									<div className="ratio ratio-4x3 ms-sm-5">
