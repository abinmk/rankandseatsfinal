...
import { Horizontaldata, Verticaldata } from "./columnsdata";
					...
					<Row>
						...
						<Col xl={12}>
							<Card className="custom-card">
								...
								<Card.Body className="bd-example-row">
									<p className="mb-4">With the move to flexbox in v4, you can use margin utilities like <span className="text-danger">.me-auto</span> to force sibling columns away from one another.
									</p>
									<div className="container">
										<Row className="mb-3">
										...
										<Row className="mb-3">
											<Col md={3} className=" ms-md-auto">.col-md-3 .ms-md-auto</Col>
											<Col md={3} className=" ms-md-auto">.col-md-3 .ms-md-auto</Col>
										</Row>
										<Row>
								...
								<Card.Body className="bd-example-row">
									<div className="container">
										{Horizontaldata.map((idx) => (
											<div className={`row justify-content-${idx.class} mb-3`} key={Math.random()}>
												<div className="col-4">
													One of two columns
												</div>
												<div className="col-4">
					...
					<Card className="custom-card">
						...
						<Card.Body className="bd-example-row">
							...
							<div className="container">
								...
								<Row>
									<Col sm={6} md={5} lg={6}>.col-sm-6 .col-md-5
										.col-lg-6</Col>
									<Col sm={6} md={5} className="offset-md-2 col-lg-6 offset-lg-0">
										.col-sm-6
					...
					<Card className="custom-card">
						<Card.Body>
							<p>The classes can be used together with utilities to create responsive floated
								images.
								Make sure to wrap the content in a <span className="text-danger">.clearfix</span> wrapper to clear the float if the text
								is shorter.</p>
							<div className="clearfix">
								<img src={media40} className="bd-placeholder-img col-md-6 float-md-end mb-3 ms-md-3 rounded img-fluid" alt="..." />
								<p>
