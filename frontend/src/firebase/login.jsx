										...
										<div className="card-body p-5 pt-1 rectangle3">
											...
											<div className="row gy-3">
												...
												<div className="col-xl-12 mb-2">
													...
													>Password<Link to={`${import.meta.env.BASE_URL}authentication/resetpassword/resetbasic`} className="float-end text-primary">Forget password ?</Link></Form.Label>
											...
											<div className="row gy-3">
												...
												<div className="col-xl-12 mb-2">
													<label htmlFor="signin-password" className="form-label text-default d-block">Password
														<Link to={`${import.meta.env.BASE_URL}authentication/resetpassword/resetbasic`} className="float-end text-primary">Forget password ?</Link></label>
													<div className="input-group">
