...
export function Basicechart() {
	...
	const [_chartWidth, setChartWidth] = useState("100%"); // Initial width is 100%
	const option = {
		grid: {
			left: "0%",
			right: "0%",
	...
	return (
		<div style={{ width: "100%", overflow: "hidden" }}>
			<ReactECharts ref={chartRef} option={option} style={{ width: "800PX", height: "300px" }} />
		</div>
	);
}
...
export function Basicareaechart() {
	...
	return (<>
		<ReactECharts option={option}  ref={chartRef} style={{ width: "800PX", height: "300px" }} />
	</>);
}
