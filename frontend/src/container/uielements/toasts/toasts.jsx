...
import { taost10, toast1, toast11, toast2, toast4, toast5, toast6, toast7, toast8, toast9 } from "../../../components/ui/data/uielementsdata/uielementsprism";

//IMAGES
import toggledark from "../../../assets/images/brand-logos/toggle-dark.png";
import favi from "../../../assets/images/brand-logos/fav.ico";
...
const Toasts = () => {
	...
	return (
		<Fragment>
			<Row>
				<Col xl={12}>
					<Showcode title="Toast Placements" code={toast1}>
			...
			<Row>
				<div className="col-xl-6">
					<Showcode title="Color Variants Live" code={toast2}>
						<div className="btn-list">
				...
				<div className="col-xl-6">
					<Showcode title="Solid Background Toasts" code={toast4}>
						<div className="btn-list">
			...
			<Row>
				<div className="col-xl-4">
					<Showcode title="Live example" code={toast5}>
						...
						<Toast className="toast-container position-fixed top-0 end-0 me-4 mt-4" onClose={() => setShow(false)} show={show} delay={3000} autohide>
							...
							<Toast.Header className="text-default mb-0">
								<img className="bd-placeholder-img rounded me-2" src={favi} alt="..." />
								<strong className="me-auto">Velvet</strong>
					...
					<Showcode title="Color schemes" code={toast6}>
				...
				<div className="col-xl-4">
					<Showcode title="Basic example" code={toast7}>
						<Toast show={showA} onClose={toggleShowA} className="toast show"
							...
							<Toast.Header className="text-default">
								<img src={favi} alt="" className="me-2" height="18" />
								<strong className="me-auto">Velvet</strong>
								<small>11 mins ago</small>
							</Toast.Header>
					...
					<Showcode title="Stacking" code={toast8
					} >
				...
				<div className="col-xl-4">
					<Showcode title="Translucent" code={toast9}>
					...
					<Showcode title="Custom content" code={taost10}>
			...
			<Row>
				<Col xl={12}>
					<Showcode title="Aligning Toast Using Flexbox" code={toast11}>
						<div className="bd-example bg-light bd-example-toasts d-flex p-0 px-3">
							<div aria-live="polite" aria-atomic="true"
								...
								<Toast show={showK} onClose={toggleShowK} className="toast fade show shadow-lg">
									<Toast.Header className="text-default">
										<img src={favi} alt="" className="bd-placeholder-img rounded me-2" />
										<strong className="me-auto">Velvet</strong>
										<small>11 mins ago</small>
									</Toast.Header>
									<Toast.Body> Hello, world! This is a toast message.</Toast.Body>
