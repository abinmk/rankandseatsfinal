...
//IMAGES
import chooseplan from "../../../assets/images/media/chooseplan.png";
		...
		<Fragment>
				...
				<Tab.Container defaultActiveKey="first">
					<Col xl={12}>
						<div className="card bg-transparent border-0">
							<h5 className="fw-semibold text-center text-fixed-white mb-0"> Simple Pricing Style-1 For Everyone </h5>
							<div className="d-flex justify-content-center mt-4">
								<Nav className="nav nav-tabs mb-3 mt-2 tab-style-6 bg-primary-transparent" role="tablist">
									<Nav.Item>
										<Nav.Link eventKey="first" id="pricing-monthly1" data-bs-toggle="tab"
									...
									<Nav.Item>
										<Nav.Link eventKey="second" id="pricing-yearly1" data-bs-toggle="tab"
					...
					<Col xl={12}>
						<Tab.Content id="myTabContent1">
							<Tab.Pane eventKey="first" className="p-0 border-0" id="pricing-monthly1-pane"
												...
												<div className="p-4">
													<div className="d-flex justify-content-between align-items-center mb-3">
														<div className="d-flex">
															...
															<div className="fs-18 fw-semibold ">Free</div>
														</div>
														<div>
															<span className="badge bg-success-transparent">For Indivudials</span>
														</div>
													</div>
													<div className="fs-25 fw-bold mb-1">$0<sub className="text-muted fw-semibold fs-11">/ Per Month</sub></div>
													<div className="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam .</div>
													<div className="fs-12 mb-3"><span>Billed Monthly</span></div>
													<ul className="list-unstyled mb-0">
														...
														<li className="d-grid">
															<button type="button" className="btn btn-light btn-wave">Choose Plan</button>
														</li>
													</ul>
												</div>
											</Card.Body>
												...
												<div className="p-4">
													<div className="d-flex justify-content-between align-items-center mb-3">
														<div className="d-flex">
															...
															<div className="fs-18 fw-semibold">Team</div>
														</div>
														<div>
													...
													<div className="p-4">
														<div className="d-flex justify-content-between align-items-center mb-3">
															<div className="d-flex">
																...
																<div className="fs-18 fw-semibold">Business</div>
															</div>
															<div>
														...
														<div className="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam .</div>
														<div className="fs-12 mb-3 text-primary"><span>Billed Monthly</span></div>
														<ul className="list-unstyled mb-0">
															<li className="d-flex align-items-center mb-3">
																<span className="me-2">
																	<i className="ri-checkbox-circle-line fs-15 text-success"></i>
															...
															<li className="d-grid">
																<button type="button" className="btn btn-primary btn-wave">Choose Plan</button>
															</li>
														</ul>
													</div>
												</Card.Body>
							...
							<Tab.Pane eventKey="second" className="tab-pane p-0 border-0" id="pricing-yearly1-pane"
										...
										<Card className="custom-card overflow-hidden">
											<Card.Body className="p-0">
												<div className="p-4">
													...
													<div className="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam .</div>
													<div className="fs-12 mb-3"><span>Billed yearly</span></div>
													<ul className="list-unstyled mb-0">
														<li className="d-flex align-items-center mb-3">
															<span className="me-2">
																<i className="ri-checkbox-circle-line fs-15 text-success"></i>
										...
										<Card className="custom-card overflow-hidden">
											<Card.Body className="p-0">
												<div className="p-4">
													...
													<div className="fs-25 fw-bold mb-1">$10,49<sub className="text-muted fw-semibold fs-11">/ Per year</sub></div>
													<div className="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam .</div>
													<div className="fs-12 mb-3"><span>Billed yearly</span></div>
													<ul className="list-unstyled mb-0">
														<li className="d-flex align-items-center mb-3">
											...
											<div className=" d-flex flex-column p-0">
												<Card.Body className="p-0">
													<div className="p-4">
														...
														<div className="fs-25 fw-bold mb-1">$50,299<sub className="text-muted fw-semibold fs-11">/ Per year</sub></div>
														<div className="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam .</div>
														<div className="fs-12 mb-3 text-primary"><span>Billed yearly</span></div>
														<ul className="list-unstyled mb-0">
															<li className="d-flex align-items-center mb-3">
																<span className="me-2">
																	<i className="ri-checkbox-circle-line fs-15 text-success"></i>
				...
				<Col xxl={10} xl={12} lg={12} md={12} sm={12}>
					<div className="container-lg">
						<Row className="justify-content-center">
							<Col xl={9}>
								<h5 className="fw-semibold text-center"> Simple Pricing Style-2 For Everyone  </h5>
								<p className="text-muted text-center my-2">Choose plan that suits best for your business needs, Our plans scales with you based on your needs</p>
							</Col>
						</Row>
						<Tab.Container defaultActiveKey="first">
							<div className="d-flex justify-content-center mb-4">
								<Nav className="nav-tabs mb-3 tab-style-6 bg-primary-transparent" id="myTab" role="tablist">
									<Nav.Item className="nav-item" role="presentation">
										<Nav.Link eventKey="first" className="nav-link" id="monthly" data-bs-toggle="tab"
											data-bs-target="#monthly-pane" type="button" role="tab"
											aria-controls="monthly-pane" aria-selected="true">Monthly</Nav.Link>
									</Nav.Item>
									<Nav.Item className="nav-item" role="presentation">
										<Nav.Link eventKey="second" className="nav-link" id="yearly" data-bs-toggle="tab"
											data-bs-target="#yearly-pane" type="button" role="tab"
											aria-controls="yearly-pane" aria-selected="false">Yearly</Nav.Link>
									</Nav.Item>
								</Nav>
							</div>
							<Tab.Content id="myTabContent">
								<Tab.Pane eventKey="first" className="p-0 border-0" id="monthly-pane"
									...
									<div className="row">
											...
											<Card className="custom-card overflow-hidden">
												<Card.Body className="p-0">
													<div className="p-4">
														...
														<ul className="list-unstyled  fs-12 pt-3 mb-0">
															<li className="mb-3">
																<span className="text-muted">Storage Capacity<span className="badge bg-light text-default ms-1">5Tb</span></span>
															</li>
															<li className="mb-3">
																<span className="text-muted">Daily Updates<span className="badge bg-light text-default ms-1">Unlimited</span></span>
															</li>
															<li className="mb-3">
																<span className="text-muted">Online Support</span>
															</li>
															<li className="mb-3">
																<span className="text-muted">Visitors Monitoring<span className="badge bg-light text-default ms-1">24/7</span></span>
															</li>
															<li className="mb-3">
																<span className="text-muted">10 Free Domains</span>
															</li>
															<li className="mb-4">
																<span className="text-muted">Money Back Guarentee</span>
															</li>
														</ul>
														<div className="d-grid">
															<button type="button" className="btn btn-primary-light btn-wave">Get Started</button>
														</div>
													</div>
												</Card.Body>
											</Card>
										...
										<div className="col-xxl-3 col-xl-4 col-lg-4 col-md-4 col-sm-12">
											<Card className="custom-card overflow-hidden">
												<Card.Body className="p-0">
													<div className="p-4">
														<h6 className="fw-semibold ">BASIC</h6>
														<div className="pb-4 pt-2 d-flex">
															<div className="">
																<p className="mt-2 text-xxl fw-semibold mb-0">$199</p>
																<p className="text-muted op-5 fs-11 fw-semibold mb-0">per month</p>
															</div>
															<div className="pricing-svg1 ms-auto">
																<svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 92 92" viewBox="0 0 92 92"><path fill="#f3eefd" d="M41.20752 46.41242c0-4.73499-3.83838-8.57336-8.57324-8.57336H9.57349C4.83862 37.83905 1 41.67743 1 46.41242v.00012c0 4.73486 3.83862 8.57324 8.57349 8.57324h23.06079c4.73486 0 8.57324-3.83838 8.57324-8.57324V46.41242zM77.82178 64.81879H48.74512c-4.73486 0-8.57324 3.8385-8.57324 8.57349 0 4.73486 3.83838 8.57324 8.57324 8.57324h29.07666c4.73486 0 8.57349-3.83838 8.57349-8.57324C86.39526 68.6573 82.55664 64.81879 77.82178 64.81879zM82.42676 22.62445H67.75488c-4.73486 0-8.57349 3.83838-8.57349 8.57336s3.83862 8.57336 8.57349 8.57336h14.67188C87.16162 39.77118 91 35.9328 91 31.19782S87.16162 22.62445 82.42676 22.62445z" className="colorf6e2ee svgShape"></path><rect width="20.97" height="64" x="14" y="18.625" fill="#ffffff" className="colorffffff svgShape"></rect><rect width="12.97" height="10.419" x="18" y="22.624" fill="#8e54e9" className="colorcf95c2 svgShape"></rect><rect width="12.97" height="10.419" x="18" y="36.957" fill="#8e54e9" className="colorcf95c2 svgShape"></rect><rect width="12.97" height="10.419" x="18" y="51.29" fill="#8e54e9" className="colorcf95c2 svgShape"></rect><rect width="64" height="20.97" x="13.012" y="43.21" fill="#ffffff" transform="rotate(-41.076 45.013 53.695)" className="colorffffff svgShape"></rect><rect width="10.419" height="12.97" x="56.983" y="32.235" fill="#8e54e9" transform="rotate(138.924 62.194 38.721)" className="colorcf95c2 svgShape"></rect><rect width="10.419" height="12.97" x="46.179" y="41.653" fill="#8e54e9" transform="rotate(138.924 51.39 48.138)" className="colorcf95c2 svgShape"></rect><rect width="10.419" height="12.97" x="35.374" y="51.07" fill="#8e54e9" transform="rotate(138.924 40.584 57.556)" className="colorcf95c2 svgShape"></rect><rect width="64" height="20.97" x="14" y="61.655" fill="#ffffff" className="colorffffff svgShape"></rect><rect width="10.419" height="12.97" x="63.581" y="65.655" fill="#8e54e9" className="colorcf95c2 svgShape"></rect><rect width="10.419" height="12.97" x="49.248" y="65.655" fill="#8e54e9" className="colorcf95c2 svgShape"></rect><rect width="10.419" height="12.97" x="34.915" y="65.655" fill="#8e54e9" className="colorcf95c2 svgShape"></rect><circle cx="24.14" cy="72.14" r="3.485" fill="#8e54e9" className="colorcf95c2 svgShape"></circle><path fill="#010101" d="M30.9751 22.12421H18.00513c-.28003 0-.5.21997-.5.5v10.42004c0 .27991.21997.5.5.5H30.9751c.27002 0 .5-.22009.5-.5V22.62421C31.4751 22.34418 31.24512 22.12421 30.9751 22.12421zM30.4751 32.54425H18.50513v-9.42004H30.4751V32.54425zM30.9751 36.45429H18.00513c-.28003 0-.5.22998-.5.5v10.41992c0 .28003.21997.5.5.5H30.9751c.27002 0 .5-.21997.5-.5V36.95429C31.4751 36.68427 31.24512 36.45429 30.9751 36.45429zM30.4751 46.87421H18.50513v-9.41992H30.4751V46.87421zM70.75513 39.85419l-8.52002-9.77002c-.17993-.20996-.5-.22998-.69995-.04993l-7.86011 6.83997c-.09985.09009-.15991.20996-.16992.3501-.01001.12988.04004.26001.11987.35986l8.52002 9.78003c.1001.11011.24023.17004.38013.17004.11987 0 .23999-.03992.32983-.13l7.8501-6.84009c.1001-.08984.16992-.20996.16992-.33984C70.88525 40.08417 70.84521 39.95429 70.75513 39.85419zM62.5752 46.32416l-7.86011-9.0199 7.1001-6.19006 7.85986 9.02002L62.5752 46.32416zM59.95508 49.27423l-8.52002-9.77991c-.18994-.20007-.5-.2301-.70996-.05005l-7.8501 6.84998c-.09985.08997-.15991.20996-.16992.33997-.01001.14001.03003.27002.12012.37l8.52002 9.77002c.09985.12.23975.17004.37988.17004.10986 0 .22998-.04004.33008-.12012l7.84985-6.83984c.1001-.09009.16016-.21008.17017-.3501C60.08496 49.50422 60.04517 49.37421 59.95508 49.27423zM51.77515 55.74433l-7.87012-9.02002 7.1001-6.19006 7.86987 9.02002L51.77515 55.74433z" className="color010101 svgShape"></path><path fill="#010101" d="M78.00513,60.65424h-23.5l22.17993-19.33008c0.41016-0.35986,0.45996-0.98999,0.09009-1.40991
                                                                            ...
                                                                            H18.00513c-0.28003,0-0.5,0.21997-0.5,0.5v9.35999h-2.5V19.62421z M77.00513,81.62421h-62V62.65424h62V81.62421z" className="color010101 svgShape"></path><path fill="#010101" d="M74.00513 65.15424H63.58496c-.27979 0-.5.21997-.5.5v12.96997c0 .28003.22021.5.5.5h10.42017c.27002 0 .5-.21997.5-.5V65.65424C74.50513 65.37421 74.27515 65.15424 74.00513 65.15424zM73.50513 78.12421h-9.42017V66.15424h9.42017V78.12421zM59.66504 65.15424H49.24512c-.27002 0-.5.21997-.5.5v12.96997c0 .28003.22998.5.5.5h10.41992c.28003 0 .5-.21997.5-.5V65.65424C60.16504 65.37421 59.94507 65.15424 59.66504 65.15424zM59.16504 78.12421h-9.41992V66.15424h9.41992V78.12421zM45.33496 65.15424H34.91504c-.27979 0-.5.21997-.5.5v12.96997c0 .28003.22021.5.5.5h10.41992c.28027 0 .5-.21997.5-.5V65.65424C45.83496 65.37421 45.61523 65.15424 45.33496 65.15424zM44.83496 78.12421h-9.41992V66.15424h9.41992V78.12421zM24.14502 68.15424c-2.19995 0-3.98999 1.79004-3.98999 3.98999 0 2.18994 1.79004 3.97998 3.98999 3.97998 2.18994 0 3.97998-1.79004 3.97998-3.97998C28.125 69.94428 26.33496 68.15424 24.14502 68.15424zM24.14502 75.12421c-1.6499 0-2.98999-1.33997-2.98999-2.97998 0-1.6499 1.34009-2.98999 2.98999-2.98999 1.64014 0 2.97998 1.34009 2.97998 2.98999C27.125 73.78425 25.78516 75.12421 24.14502 75.12421z" className="color010101 svgShape"></path><circle cx="68.791" cy="11.094" r="2.719" fill="#dff8f1" className="colordfebf8 svgShape"></circle><circle cx="48.008" cy="17.343" r="2.291" fill="#d6fdf2" className="colorfdddd6 svgShape"></circle><circle cx="85.592" cy="52.839" r="2.291" fill="#8e54e9" className="color84b0de svgShape"></circle><circle cx="7.956" cy="80.915" r="2.291" fill="#d2f6ec" className="colord2edf6 svgShape"></circle><circle cx="6.652" cy="25.369" r="1.303" fill="#5cfdd0" className="colorfdbe5c svgShape"></circle></svg>
															</div>
														</div>
														<ul className="list-unstyled  fs-12 pt-3 mb-0">
															<li className="mb-3">
																<span className="text-muted">Storage Capacity<span className="badge bg-light text-default ms-1">1Tb</span></span>
															</li>
															<li className="mb-3">
																<span className="text-muted">Daily Updates<span className="badge bg-light text-default ms-1">Unlimited</span></span>
															</li>
											...
											<Card className="custom-card overflow-hidden">
												<Card.Body className="p-0">
													<div className="p-4">
														...
														<div className="pb-4 pt-2 d-flex">
															<div className="">
																<p className="mt-2 text-xxl fw-semibold mb-0">$499</p>
																<p className="text-muted op-5 fs-11 fw-semibold mb-0">per month</p>
															</div>
															<div className="pricing-svg1 ms-auto">
																<svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 92 92" viewBox="0 0 92 92"><path fill="#f3eefd" d="M32.63403 32.90607H9.57324C4.83838 32.90607 1 36.74445 1 41.47956c0 4.73486 3.83838 8.57324 8.57324 8.57324h23.06079c4.73486 0 8.57324-3.83838 8.57324-8.57324C41.20728 36.74445 37.3689 32.90607 32.63403 32.90607zM77.82153 59.88581H48.74487c-4.73511 0-8.57349 3.8385-8.57349 8.57349l0 0c0 4.73486 3.83838 8.57336 8.57349 8.57336h29.07666c4.73511 0 8.57349-3.8385 8.57349-8.57336l0 0C86.39502 63.72431 82.55664 59.88581 77.82153 59.88581zM82.42651 17.69147H67.75464c-4.73511 0-8.57349 3.83838-8.57349 8.57336s3.83838 8.57336 8.57349 8.57336h14.67188C87.16162 34.8382 91 30.99982 91 26.26484S87.16162 17.69147 82.42651 17.69147z"></path><rect width="36.443" height="15.95" x="28.529" y="39.369" fill="#8e54e9"></rect><rect width="23.14" height="10.128" x="15.251" y="68.248" fill="#8e54e9"></rect><rect width="23.14" height="10.128" x="55.111" y="68.248" fill="#8e54e9"></rect><rect width="28.569" height="8.075" x="32.467" y="43.306" fill="#FFF"></rect><circle cx="21.126" cy="73.312" r="1.822" fill="#FFF"></circle><circle cx="26.821" cy="73.312" r="1.822" fill="#FFF"></circle><circle cx="32.517" cy="73.312" r="1.822" fill="#FFF"></circle><circle cx="60.985" cy="73.312" r="1.822" fill="#FFF"></circle><circle cx="66.681" cy="73.312" r="1.822" fill="#FFF"></circle><circle cx="72.376" cy="73.312" r="1.822" fill="#FFF"></circle><rect width="12.396" height="12.396" x="16.819" y="15.375" fill="#FFF"></rect><rect width="12.396" height="12.396" x="64.287" y="15.375" fill="#FFF"></rect><circle cx="46.751" cy="29.347" r="5.005" fill="#FFF"></circle><circle cx="46.751" cy="66.754" r="5.005" fill="#FFF"></circle><rect width="7.349" height="7.349" x="70.902" y="50.917" fill="#FFF"></rect><rect width="7.349" height="7.349" x="15.251" y="50.917" fill="#FFF"></rect><path fill="#010101" d="M38.3916 67.24335H19.42163v-8.47998h3.17993c.27002 0 .5-.22009.5-.5v-7.34998c0-.27002-.22998-.5-.5-.5h-7.34985c-.28003 0-.5.22998-.5.5v7.34998c0 .27991.21997.5.5.5h3.16992v8.47998h-3.16992c-.55005 0-1 .45007-1 1v10.13c0 .55005.44995 1 1 1H38.3916c.55005 0 1-.44995 1-1v-10.13C39.3916 67.69343 38.94165 67.24335 38.3916 67.24335zM15.75171 57.76337v-6.34998h6.34985v6.34998C19.90606 57.76337 18.13821 57.76337 15.75171 57.76337zM37.3916 77.37336H16.25171v-8.13H37.3916V77.37336zM78.25171 67.24335h-3.17993v-8.47998h3.17993c.28003 0 .5-.22009.5-.5v-7.34998c0-.27002-.21997-.5-.5-.5h-7.34985c-.28027 0-.5.22998-.5.5v7.34998c0 .27991.21973.5.5.5h3.16992v8.47998H55.11182c-.55005 0-1 .45007-1 1v10.13c0 .55005.44995 1 1 1h23.13989c.55005 0 1-.44995 1-1v-10.13C79.25171 67.69343 78.80176 67.24335 78.25171 67.24335zM71.40186 57.76337v-6.34998h6.34985v6.34998C75.55621 57.76337 73.78835 57.76337 71.40186 57.76337zM77.25171 77.37336H56.11182v-8.13h21.13989V77.37336z"></path><path fill="#010101" d="M47.25171,61.28327v-4.95996h17.71997c0.55005,0,1-0.44995,1-1V43.09333h4.51001
											...
											<Card className="custom-card overflow-hidden">
												<Card.Body className="p-0">
													<div className="p-4 pricing-offer overflow-hidden">
														...
														<ul className="list-unstyled  fs-12 pt-3 mb-0">
															<li className="mb-3">
																<span className="text-muted">Storage Capacity<span className="badge bg-light text-default ms-1">10Tb</span></span>
															</li>
															<li className="mb-3">
																<span className="text-muted">Daily Updates<span className="badge bg-light text-default ms-1">Unlimited</span></span>
															</li>
														...
														<div className="d-grid">
															<button type="button" className="btn btn-primary btn-wave">Get Started</button>
														</div>
													</div>
												</Card.Body>
											</Card>
								...
								<Tab.Pane eventKey="second" className="p-0 border-0" id="yearly-pane"
												...
												<Card.Body className="p-0">
													<div className="p-4">
														...
														<div className="pb-4 pt-2 d-flex">
															<div className="">
																<p className="mt-2 text-xxl fw-semibold mb-0">$0</p>
																<p className="text-muted op-5 fs-11 fw-semibold mb-0">per year</p>
															</div>
															<div className="pricing-svg1 ms-auto">
																<svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 92 92" viewBox="0 0 92 92"><path fill="#f3eefd" d="M32.63403 32.90607H9.57324C4.83838 32.90607 1 36.74445 1 41.47956c0 4.73486 3.83838 8.57324 8.57324 8.57324h23.06079c4.73486 0 8.57324-3.83838 8.57324-8.57324C41.20728 36.74445 37.3689 32.90607 32.63403 32.90607zM77.82153 59.88581H48.74487c-4.73511 0-8.57349 3.8385-8.57349 8.57349l0 0c0 4.73486 3.83838 8.57336 8.57349 8.57336h29.07666c4.73511 0 8.57349-3.8385 8.57349-8.57336l0 0C86.39502 63.72431 82.55664 59.88581 77.82153 59.88581zM82.42651 17.69147H67.75464c-4.73511 0-8.57349 3.83838-8.57349 8.57336s3.83838 8.57336 8.57349 8.57336h14.67188C87.16162 34.8382 91 30.99982 91 26.26484S87.16162 17.69147 82.42651 17.69147z"></path><rect width="36.443" height="15.95" x="28.529" y="39.369" fill="#8e54e9"></rect><rect width="23.14" height="10.128" x="15.251" y="68.248" fill="#8e54e9"></rect><rect width="23.14" height="10.128" x="55.111" y="68.248" fill="#8e54e9"></rect><rect width="28.569" height="8.075" x="32.467" y="43.306" fill="#FFF"></rect><circle cx="21.126" cy="73.312" r="1.822" fill="#FFF"></circle><circle cx="26.821" cy="73.312" r="1.822" fill="#FFF"></circle><circle cx="32.517" cy="73.312" r="1.822" fill="#FFF"></circle><circle cx="60.985" cy="73.312" r="1.822" fill="#FFF"></circle><circle cx="66.681" cy="73.312" r="1.822" fill="#FFF"></circle><circle cx="72.376" cy="73.312" r="1.822" fill="#FFF"></circle><rect width="12.396" height="12.396" x="16.819" y="15.375" fill="#FFF"></rect><rect width="12.396" height="12.396" x="64.287" y="15.375" fill="#FFF"></rect><circle cx="46.751" cy="29.347" r="5.005" fill="#FFF"></circle><circle cx="46.751" cy="66.754" r="5.005" fill="#FFF"></circle><rect width="7.349" height="7.349" x="70.902" y="50.917" fill="#FFF"></rect><rect width="7.349" height="7.349" x="15.251" y="50.917" fill="#FFF"></rect><path fill="#010101" d="M38.3916 67.24335H19.42163v-8.47998h3.17993c.27002 0 .5-.22009.5-.5v-7.34998c0-.27002-.22998-.5-.5-.5h-7.34985c-.28003 0-.5.22998-.5.5v7.34998c0 .27991.21997.5.5.5h3.16992v8.47998h-3.16992c-.55005 0-1 .45007-1 1v10.13c0 .55005.44995 1 1 1H38.3916c.55005 0 1-.44995 1-1v-10.13C39.3916 67.69343 38.94165 67.24335 38.3916 67.24335zM15.75171 57.76337v-6.34998h6.34985v6.34998C19.90606 57.76337 18.13821 57.76337 15.75171 57.76337zM37.3916 77.37336H16.25171v-8.13H37.3916V77.37336zM78.25171 67.24335h-3.17993v-8.47998h3.17993c.28003 0 .5-.22009.5-.5v-7.34998c0-.27002-.21997-.5-.5-.5h-7.34985c-.28027 0-.5.22998-.5.5v7.34998c0 .27991.21973.5.5.5h3.16992v8.47998H55.11182c-.55005 0-1 .45007-1 1v10.13c0 .55005.44995 1 1 1h23.13989c.55005 0 1-.44995 1-1v-10.13C79.25171 67.69343 78.80176 67.24335 78.25171 67.24335zM71.40186 57.76337v-6.34998h6.34985v6.34998C75.55621 57.76337 73.78835 57.76337 71.40186 57.76337zM77.25171 77.37336H56.11182v-8.13h21.13989V77.37336z"></path><path fill="#010101" d="M47.25171,61.28327v-4.95996h17.71997c0.55005,0,1-0.44995,1-1V43.09333h4.51001
                                                                        c0.28003,0,0.5-0.21997,0.5-0.5V28.27326h5.69995c0.28003,0,0.5-0.22998,0.5-0.5v-12.3999c0-0.27002-0.21997-0.5-0.5-0.5
											...
											<Card className="custom-card overflow-hidden">
												<Card.Body className="p-0">
													<div className="p-4">
														...
														<div className="pb-4 pt-2 d-flex">
															<div className="">
																<p className="mt-2 text-xxl fw-semibold mb-0">$1199</p>
																<p className="text-muted op-5 fs-11 fw-semibold mb-0">per year</p>
															</div>
															<div className="pricing-svg1 ms-auto">
																<svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 92 92" viewBox="0 0 92 92"><path fill="#f3eefd" d="M41.20752 46.41242c0-4.73499-3.83838-8.57336-8.57324-8.57336H9.57349C4.83862 37.83905 1 41.67743 1 46.41242v.00012c0 4.73486 3.83862 8.57324 8.57349 8.57324h23.06079c4.73486 0 8.57324-3.83838 8.57324-8.57324V46.41242zM77.82178 64.81879H48.74512c-4.73486 0-8.57324 3.8385-8.57324 8.57349 0 4.73486 3.83838 8.57324 8.57324 8.57324h29.07666c4.73486 0 8.57349-3.83838 8.57349-8.57324C86.39526 68.6573 82.55664 64.81879 77.82178 64.81879zM82.42676 22.62445H67.75488c-4.73486 0-8.57349 3.83838-8.57349 8.57336s3.83862 8.57336 8.57349 8.57336h14.67188C87.16162 39.77118 91 35.9328 91 31.19782S87.16162 22.62445 82.42676 22.62445z" className="colorf6e2ee svgShape"></path><rect width="20.97" height="64" x="14" y="18.625" fill="#ffffff" className="colorffffff svgShape"></rect><rect width="12.97" height="10.419" x="18" y="22.624" fill="#8e54e9" className="colorcf95c2 svgShape"></rect><rect width="12.97" height="10.419" x="18" y="36.957" fill="#8e54e9" className="colorcf95c2 svgShape"></rect><rect width="12.97" height="10.419" x="18" y="51.29" fill="#8e54e9" className="colorcf95c2 svgShape"></rect><rect width="64" height="20.97" x="13.012" y="43.21" fill="#ffffff" transform="rotate(-41.076 45.013 53.695)" className="colorffffff svgShape"></rect><rect width="10.419" height="12.97" x="56.983" y="32.235" fill="#8e54e9" transform="rotate(138.924 62.194 38.721)" className="colorcf95c2 svgShape"></rect><rect width="10.419" height="12.97" x="46.179" y="41.653" fill="#8e54e9" transform="rotate(138.924 51.39 48.138)" className="colorcf95c2 svgShape"></rect><rect width="10.419" height="12.97" x="35.374" y="51.07" fill="#8e54e9" transform="rotate(138.924 40.584 57.556)" className="colorcf95c2 svgShape"></rect><rect width="64" height="20.97" x="14" y="61.655" fill="#ffffff" className="colorffffff svgShape"></rect><rect width="10.419" height="12.97" x="63.581" y="65.655" fill="#8e54e9" className="colorcf95c2 svgShape"></rect><rect width="10.419" height="12.97" x="49.248" y="65.655" fill="#8e54e9" className="colorcf95c2 svgShape"></rect><rect width="10.419" height="12.97" x="34.915" y="65.655" fill="#8e54e9" className="colorcf95c2 svgShape"></rect><circle cx="24.14" cy="72.14" r="3.485" fill="#8e54e9" className="colorcf95c2 svgShape"></circle><path fill="#010101" d="M30.9751 22.12421H18.00513c-.28003 0-.5.21997-.5.5v10.42004c0 .27991.21997.5.5.5H30.9751c.27002 0 .5-.22009.5-.5V22.62421C31.4751 22.34418 31.24512 22.12421 30.9751 22.12421zM30.4751 32.54425H18.50513v-9.42004H30.4751V32.54425zM30.9751 36.45429H18.00513c-.28003 0-.5.22998-.5.5v10.41992c0 .28003.21997.5.5.5H30.9751c.27002 0 .5-.21997.5-.5V36.95429C31.4751 36.68427 31.24512 36.45429 30.9751 36.45429zM30.4751 46.87421H18.50513v-9.41992H30.4751V46.87421zM70.75513 39.85419l-8.52002-9.77002c-.17993-.20996-.5-.22998-.69995-.04993l-7.86011 6.83997c-.09985.09009-.15991.20996-.16992.3501-.01001.12988.04004.26001.11987.35986l8.52002 9.78003c.1001.11011.24023.17004.38013.17004.11987 0 .23999-.03992.32983-.13l7.8501-6.84009c.1001-.08984.16992-.20996.16992-.33984C70.88525 40.08417 70.84521 39.95429 70.75513 39.85419zM62.5752 46.32416l-7.86011-9.0199 7.1001-6.19006 7.85986 9.02002L62.5752 46.32416zM59.95508 49.27423l-8.52002-9.77991c-.18994-.20007-.5-.2301-.70996-.05005l-7.8501 6.84998c-.09985.08997-.15991.20996-.16992.33997-.01001.14001.03003.27002.12012.37l8.52002 9.77002c.09985.12.23975.17004.37988.17004.10986 0 .22998-.04004.33008-.12012l7.84985-6.83984c.1001-.09009.16016-.21008.17017-.3501C60.08496 49.50422 60.04517 49.37421 59.95508 49.27423zM51.77515 55.74433l-7.87012-9.02002 7.1001-6.19006 7.86987 9.02002L51.77515 55.74433z" className="color010101 svgShape"></path><path fill="#010101" d="M78.00513,60.65424h-23.5l22.17993-19.33008c0.41016-0.35986,0.45996-0.98999,0.09009-1.40991
											...
											<Card className="custom-card overflow-hidden">
												<Card.Body className="p-0">
													<div className="p-4">
														...
														<div className="pb-4 pt-2 d-flex">
															<div className="">
																<p className="mt-2 text-xxl fw-semibold mb-0">$1499</p>
																<p className="text-muted op-5 fs-11 fw-semibold mb-0">per year</p>
															</div>
															<div className="pricing-svg1 ms-auto">
																<svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 92 92" viewBox="0 0 92 92"><path fill="#f3eefd" d="M32.63403 32.90607H9.57324C4.83838 32.90607 1 36.74445 1 41.47956c0 4.73486 3.83838 8.57324 8.57324 8.57324h23.06079c4.73486 0 8.57324-3.83838 8.57324-8.57324C41.20728 36.74445 37.3689 32.90607 32.63403 32.90607zM77.82153 59.88581H48.74487c-4.73511 0-8.57349 3.8385-8.57349 8.57349l0 0c0 4.73486 3.83838 8.57336 8.57349 8.57336h29.07666c4.73511 0 8.57349-3.8385 8.57349-8.57336l0 0C86.39502 63.72431 82.55664 59.88581 77.82153 59.88581zM82.42651 17.69147H67.75464c-4.73511 0-8.57349 3.83838-8.57349 8.57336s3.83838 8.57336 8.57349 8.57336h14.67188C87.16162 34.8382 91 30.99982 91 26.26484S87.16162 17.69147 82.42651 17.69147z"></path><rect width="36.443" height="15.95" x="28.529" y="39.369" fill="#8e54e9"></rect><rect width="23.14" height="10.128" x="15.251" y="68.248" fill="#8e54e9"></rect><rect width="23.14" height="10.128" x="55.111" y="68.248" fill="#8e54e9"></rect><rect width="28.569" height="8.075" x="32.467" y="43.306" fill="#FFF"></rect><circle cx="21.126" cy="73.312" r="1.822" fill="#FFF"></circle><circle cx="26.821" cy="73.312" r="1.822" fill="#FFF"></circle><circle cx="32.517" cy="73.312" r="1.822" fill="#FFF"></circle><circle cx="60.985" cy="73.312" r="1.822" fill="#FFF"></circle><circle cx="66.681" cy="73.312" r="1.822" fill="#FFF"></circle><circle cx="72.376" cy="73.312" r="1.822" fill="#FFF"></circle><rect width="12.396" height="12.396" x="16.819" y="15.375" fill="#FFF"></rect><rect width="12.396" height="12.396" x="64.287" y="15.375" fill="#FFF"></rect><circle cx="46.751" cy="29.347" r="5.005" fill="#FFF"></circle><circle cx="46.751" cy="66.754" r="5.005" fill="#FFF"></circle><rect width="7.349" height="7.349" x="70.902" y="50.917" fill="#FFF"></rect><rect width="7.349" height="7.349" x="15.251" y="50.917" fill="#FFF"></rect><path fill="#010101" d="M38.3916 67.24335H19.42163v-8.47998h3.17993c.27002 0 .5-.22009.5-.5v-7.34998c0-.27002-.22998-.5-.5-.5h-7.34985c-.28003 0-.5.22998-.5.5v7.34998c0 .27991.21997.5.5.5h3.16992v8.47998h-3.16992c-.55005 0-1 .45007-1 1v10.13c0 .55005.44995 1 1 1H38.3916c.55005 0 1-.44995 1-1v-10.13C39.3916 67.69343 38.94165 67.24335 38.3916 67.24335zM15.75171 57.76337v-6.34998h6.34985v6.34998C19.90606 57.76337 18.13821 57.76337 15.75171 57.76337zM37.3916 77.37336H16.25171v-8.13H37.3916V77.37336zM78.25171 67.24335h-3.17993v-8.47998h3.17993c.28003 0 .5-.22009.5-.5v-7.34998c0-.27002-.21997-.5-.5-.5h-7.34985c-.28027 0-.5.22998-.5.5v7.34998c0 .27991.21973.5.5.5h3.16992v8.47998H55.11182c-.55005 0-1 .45007-1 1v10.13c0 .55005.44995 1 1 1h23.13989c.55005 0 1-.44995 1-1v-10.13C79.25171 67.69343 78.80176 67.24335 78.25171 67.24335zM71.40186 57.76337v-6.34998h6.34985v6.34998C75.55621 57.76337 73.78835 57.76337 71.40186 57.76337zM77.25171 77.37336H56.11182v-8.13h21.13989V77.37336z"></path><path fill="#010101" d="M47.25171,61.28327v-4.95996h17.71997c0.55005,0,1-0.44995,1-1V43.09333h4.51001
											...
											<Card className="custom-card overflow-hidden">
												<Card.Body className="p-0">
													<div className="p-4 pricing-offer overflow-hidden">
														...
														<div className="pb-4 pt-2 d-flex">
															<div className="">
																<p className="mt-2 text-xxl fw-semibold mb-0">$11,299</p>
																<p className="text-muted op-5 fs-11 fw-semibold mb-0">per year</p>
															</div>
															<div className="pricing-svg1 ms-auto">
																<svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 92 92" viewBox="0 0 92 92"><path fill="#f3eefd" d="M32.66125 30.99631H9.69348c-4.55225 0-8.24268 3.69031-8.24268 8.24255s3.69043 8.24255 8.24268 8.24255h22.96777c4.55225 0 8.24243-3.69031 8.24243-8.24255S37.2135 30.99631 32.66125 30.99631zM71.80823 35.48313h8.73999c4.55225 0 8.24243-3.69037 8.24243-8.24255v-.00006c0-4.55219-3.69019-8.24255-8.24243-8.24255h-8.73999c-4.55225 0-8.24268 3.69037-8.24268 8.24255v.00006C63.56555 31.79276 67.25598 35.48313 71.80823 35.48313zM82.30652 59.57212H67.62024c-4.55225 0-8.24243 3.69037-8.24243 8.24256v.00006c0 4.55219 3.69019 8.24255 8.24243 8.24255h14.68628c4.55225 0 8.24268-3.69037 8.24268-8.24255v-.00006C90.54919 63.26249 86.85876 59.57212 82.30652 59.57212z"></path><path fill="#8e54e9" d="M75.14807,56.70884H31.23083c-1.16602,0-2.11133,0.94525-2.11133,2.11133v17.98908
			...
			<Row className="mb-5">
				<Tab.Container defaultActiveKey="first">
					<Col xl={12}>
						<div className="card bg-transparent border-0">
							<h5 className="fw-semibold text-center  mb-0">Pricing Plans</h5>
							<p className="text-muted text-center  op-7">Select best plans that fits your needs for your business growth,plans are flexible with the enterprise.Familiarize with the payment plans below</p>
							<div className="d-flex justify-content-center mt-4">
								<Nav className="nav nav-tabs mb-3 tab-style-6 bg-primary-transparent" id="myTab3" role="tablist">
									<Nav.Item className="nav-item" role="presentation">
										<Nav.Link eventKey="first" id="pricing-monthly3" data-bs-toggle="tab"
											data-bs-target="#pricing-monthly3-pane" type="button" role="tab"
											aria-controls="pricing-monthly3-pane" aria-selected="true">Monthly</Nav.Link>
									</Nav.Item>
									<Nav.Item className="nav-item" role="presentation">
										<Nav.Link eventKey="second" id="pricing-yearly3" data-bs-toggle="tab"
											data-bs-target="#pricing-yearly3-pane" type="button" role="tab"
											aria-controls="pricing-yearly3-pane" aria-selected="false">Yearly</Nav.Link>
									</Nav.Item>
								</Nav>
							</div>
					...
					<Col xl={12}>
						<Tab.Content id="myTabContent3">
							<Tab.Pane eventKey="first" className="p-0 border-0" id="pricing-monthly3-pane"
								role="tabpanel" aria-labelledby="pricing-monthly3" tabIndex={0}>
								<div className="row justify-content-center">
									<div className="col-xxl-9 col-xl-12 col-md-12 col-lg-12 col-sm-12">
										<div className="container-lg">
												...
												<div className="card-body">
													<div className="table-responsive">
														<table className="table table-bordered text-nowrap">
															<thead>
																<tr>
																	<th scope="col" className="text-center">
																		<p className="fs-18 fw-semibold mb-3 h5">Chek Our Plans</p>
																		<img src={chooseplan} alt="" className="wd-150" />
																	</th>
																	<th scope="col" className="text-center c">
																		<div className="avatar avatar-md rounded-circle bg-light mb-2">
																			<i className="bx bx-bolt-circle fs-24 text-primary"></i>
																		</div>
																		<p className="fs-18 mb-0 fw-semibold h5">Basic</p>
																		<span className="text-xxl fw-semibold text-dark">$99</span>
																		<p className="text-muted fs-12 mb-2">per month</p>
																		<div className="d-grid">
																			<button type="button" className="btn btn-primary-light btn-wave">Get started</button>
																		</div>
																	</th>
																	<th scope="col" className="text-center ">
																		<div className="avatar avatar-md rounded-circle bg-light mb-2">
																			<i className="bx bx-data  fs-24 text-primary" ></i>
																		</div>
																		<p className="fs-18 mb-0 fw-semibold h5">Pro</p>
																		<span className="text-xxl fw-semibold text-dark">$3,499</span>
																		<p className="text-muted fs-12 mb-2">per month</p>
																		<div className="d-grid">
																			<button type="button" className="btn btn-primary-light btn-wave">Get started</button>
																		</div>
																	...
																	<th scope="col" className="text-center ">
																		<div className="avatar avatar-md rounded-circle bg-light mb-2">
																			<i className="bx bx-crown  fs-24 text-primary" ></i>
																		</div>
																		<p className="fs-18 mb-0 fw-semibold h5">Premium</p>
																		<span className="text-xxl fw-semibold text-dark">$5,499</span>
																		<p className="text-muted fs-12 mb-2">per month</p>
																		<div className="d-grid">
																			<button type="button" className="btn btn-primary-light btn-wave">Get started</button>
																		</div>
															...
															<tbody>
																<tr className="text-center bg-primary-transparent">
																	<td colSpan={4}>
																		<span className="fs-14 fw-semibold">Main Features</span>
																	</td>
																</tr>
																<tr>
																	<td></td>
																	<td>
																		<span>
																			24/7 support <span className="badge bg-primary ms-2">1
																				Year</span>
																		</span>
																	</td>
																	<td>
																		<span>
																			24/7 support <span className="badge bg-primary ms-2">5
																				Year</span>
																		</span>
																	</td>
																	<td>
																		<span>
																			24/7 support <span className="badge bg-primary ms-2">Life
																				Long</span>
																		</span>
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<span>
																			Storage Capacity <span className="badge bg-success ms-2">1
																				TB</span>
																		</span>
																	</td>
																	<td>
																		<span>
																			Storage Capacity <span className="badge bg-success ms-2">5
																				TB</span>
																		</span>
																	</td>
																	<td>
																		<span>
																			Storage Capacity <span className="badge bg-success ms-2">10
																				TB</span>
																		</span>
																	</td>
																</tr>
																<tr className="text-center bg-primary-transparent">
																	<td colSpan={4}>
																		<span className="fs-14 fw-semibold">Complete Features</span>
																	</td>
																</tr>
																<tr>
																	<td>
																	...
																	<td>
																		<span className="fw-semibold">2 Free</span> Domain names
																	</td>
																	<td>
																		<span className="fw-semibold">5 Free</span> Domain names
																	</td>
																	<td>
																		<span className="fw-semibold">10 Free</span> Domain names
																	</td>
																</tr>
																<tr>
																	<td>
																	...
																	<td>
																		<span
																			className="badge bg-success-transparent p-1 lh-1 rounded-circle">
																...
																<tr>
																	...
																	<td>
																		<span
																			className="badge bg-danger-transparent p-1 lh-1 rounded-circle">
							...
							<Tab.Pane eventKey="second" className="p-0 border-0" id="pricing-yearly3-pane"
															...
															<thead>
																<tr>
																	...
																	<th scope="col" className="text-center c">
																		...
																		<p className="fs-18 mb-0 fw-semibold h5">Basic</p>
																		<span className="text-xxl fw-semibold text-dark">$999</span>
																		<p className="text-muted fs-12 mb-2">per year </p>
																		<div className="d-grid">
																			<button type="button" className="btn btn-primary-light btn-wave">Get started</button>
																		</div>
																	</th>
																	<th scope="col" className="text-center ">
																		...
																		<p className="fs-18 mb-0 fw-semibold h5">Pro</p>
																		<span className="text-xxl fw-semibold text-dark">$93,499</span>
																		<p className="text-muted fs-12 mb-2">per year </p>
																		<div className="d-grid">
																			<button type="button" className="btn btn-primary-light btn-wave">Get started</button>
																		</div>
																	...
																	<th scope="col" className="text-center ">
																		...
																		<p className="fs-18 mb-0 fw-semibold h5">Premium</p>
																		<span className="text-xxl fw-semibold text-dark">$95,499</span>
																		<p className="text-muted fs-12 mb-2">per year </p>
																		<div className="d-grid">
																			<button type="button" className="btn btn-primary-light btn-wave">Get started</button>
																		</div>
