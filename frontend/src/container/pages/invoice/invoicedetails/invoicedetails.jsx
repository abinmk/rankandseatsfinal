					...
					<Card className="custom-card">
						<Card.Header className="d-md-flex d-block">
							...
							<div className="ms-auto mt-md-0 mt-2">
								<Button variant='' className="btn btn-secondary me-1" onClick={() => print()}>Print<i className="ri-printer-line ms-1 align-middle d-inline-flex"></i></Button>
								<Button variant='' className="btn btn-primary">Save As PDF<i className="ri-file-pdf-line ms-1 align-middle d-inline-flex"></i></Button>
							</div>
						</Card.Header>
						<Card.Body>
