...
import { validate1, validate2, validate3, validate4, validate5 } from "../../../components/ui/data/formsdata/formsprism";
...
const Validation = () => {
	...
	return (
		<Fragment>
			<Row>
				<Col xl={6}>
					<Showcode title="Custom Validation" code={validate1}>
                    ...
                    <InputGroup hasValidation>
                      ...
                      <Form.Control.Feedback type="invalid">
                        Please choose a username.
								...
								<div className="col-12"><button type="submit" className="btn btn-primary btn btn-primary">Submit form</button></div>
							</Row>
						</Form>
					</Showcode>
				</Col>
				<Col xl={6}>
					<Showcode title="Browser default Validation" code={validate2}>
			...
			<Row>
				<Col xl={6}>
					<Row>
						<Col xl={12}>
							<Showcode title="Server side Validation" code={validate3}>
								<Form className="row g-3">
									<Col md={4}>
						...
						<Col xl={12}>
							<Showcode title="Tooltips" code={validate4}>
								<Formik
				...
				<Col xl={6}>
					<Showcode title=" Supported elements" code={validate5}>
