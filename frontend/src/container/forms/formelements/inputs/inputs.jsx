...
import { inputs1, inputs2, inputs3, inputs4, inputs5, inputs6, inputs7, inputs8 } from "../../../../components/ui/data/formsdata/formsprism";
					...
					<Showcode title="Input Types" code={inputs1}>
						<div className="row gy-4">
							...
							<Col xl={4} lg={6} md={6} sm={12}>
								...
								<Form.Control type="text" readOnly className="" id="input-readonlytext" defaultValue="email@example.com" />
							</Col>
							<Col xl={4} lg={6} md={6} sm={12}>
			...
			<Row>
				...
				<Col xl={6}>
					<Row>
						...
						<Col xl={12}>
							<Showcode title="Inline text can use any typical inline HTML element with nothing more than the <span class='text-danger'>.form-text</span> class." code={inputs7}>
