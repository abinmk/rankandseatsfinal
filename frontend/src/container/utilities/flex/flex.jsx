...
import { Contentdata, Contentdata1, Contentdata3, Contentdata4 } from "./flexdata";
						...
						<Card.Body>
							<div className="d-flex mb-3">
								<div className="flex-shrink-0">
									<img className="bd-placeholder-img card-img w-10 h-10" src={faces6} alt="img" />
								</div>
							...
							<div className="d-flex align-items-center">
								<div className="flex-shrink-0">
									<img className="bd-placeholder-img card-img avatar-xl" src={faces15} alt="img" />
								</div>
								<div className="flex-grow-1 ms-3">
