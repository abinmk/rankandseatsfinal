						...
						<Col xl={12}>
							<Card className="custom-card">
								...
								<Card.Body>
									...
									<span className="d-block p-2 bg-warning-transparent mb-1 rounded">d-block</span>
								</Card.Body>
							</Card>
						</Col>
					</Row>
					...
					<Row>
						...
						<Col xl={12}>
							<Card className="custom-card">
								...
								<Card.Body>
									<p><Link to="#" className="pe-none" tabIndex={-1}><code className="text-primary fw-semibold">This link </code></Link>
										can
										not be clicked.
									</p>
									...
									<p className="pe-none mb-0"><Link to="#" tabIndex={-1}><code>This link </code></Link>
										can
