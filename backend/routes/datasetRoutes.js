...
router.get('/list-available-allotments', datasetController.listAvailableAllotments); // New route
router.post('/generate-combined-dataset', datasetController.generateCombinedDataset);

router.get('/get-generated-data', datasetController.getGeneratedData);
